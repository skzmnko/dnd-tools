...
export class AdditionalFieldsComponent {
  ...
  render(container: HTMLElement) {
    ...
    new Setting(section)
      ...
      .addTextArea((text) => {
        text
          .setPlaceholder(i18n.t("ADDITIONAL_FIELDS.SKILLS_PLACEHOLDER"))
    ...
    new Setting(section)
      ...
      .addTextArea((text) => {
        text
          .setPlaceholder(i18n.t("ADDITIONAL_FIELDS.SENSES_PLACEHOLDER"))
    ...
    this.alchemySetting = new Setting(section)
      ...
      .addTextArea((text) => {
        text
          .setPlaceholder(
            i18n.t("ADDITIONAL_FIELDS.ALCHEMY_INGREDIENTS_PLACEHOLDER"),
          )
    ...
    this.craftSetting = new Setting(section)
      ...
      .addTextArea((text) => {
        text
          .setPlaceholder(
            i18n.t("ADDITIONAL_FIELDS.CRAFT_INGREDIENTS_PLACEHOLDER"),
          )
    ...
    this.statementsSetting = new Setting(section)
      ...
      .addTextArea((text) => {
        text
          .setPlaceholder(i18n.t("ADDITIONAL_FIELDS.STATEMENTS_PLACEHOLDER"))
    ...
    new Setting(section)
      ...
      .addTextArea((text) => {
        text
          .setPlaceholder(i18n.t("ADDITIONAL_FIELDS.TACTICS_PLACEHOLDER"))
  ...
  toggleIngredientsVisibility(isHumanoid: boolean): void {
    if (!this.alchemySetting || !this.craftSetting || !this.statementsSetting)
      return;
  ...
  getCraftIngredients(): string {
    return this.craft_ingredients;
  }
