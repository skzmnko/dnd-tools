...
export class BasicFieldsComponent {
  ...
  render(container: HTMLElement) {
    ...
    new Setting(section)
      ...
      .addDropdown((dropdown) => {
        ...
        ALIGNMENTS.forEach((alignmentKey) => {
          dropdown.addOption(
            alignmentKey,
            alignments[alignmentKey] || alignmentKey,
          );
        });
        dropdown
    ...
    new Setting(section)
      ...
      .addTextArea((text) => {
        text
          .setPlaceholder(i18n.t("BASIC_FIELDS.LANGUAGES_PLACEHOLDER"))
    ...
    this.notableItemsSetting = new Setting(section)
      ...
      .addTextArea((text) => {
        text
          .setPlaceholder(i18n.t("BASIC_FIELDS.NOTABLE_ITEMS_PLACEHOLDER"))
  ...
  getNotableItems(): string {
    return this.notable_items;
  }
}
